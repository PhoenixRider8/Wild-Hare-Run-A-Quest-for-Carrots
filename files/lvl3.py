...
class Start3(object):
    ...
    carrots=[Carrot(100,180,32,32),Carrot(356,450,32,32),Carrot(656,450,32,32)]
    wolves=[Enemy(700,380,45,30,800),Enemy(1000,180,45,30,1100)]
    gate=Door(1200,180,72,83,0)
    clock=pygame.time.Clock()

    lvl1=[Block(100,400,64,64),Block(200,350,64,64),Block(164,350,64,64),Block(400,280,64,64),Block(100,180,64,64),
          Block(700,380,64,64),Block(764,380,64,64),Block(1000,180,64,64),Block(1064,180,64,64),Block(284,380,64,64),
        ...
        while running:
            ...
            for wolf in self.wolves:
                if wolf.rect.colliderect(self.rabbit.rect.x, self.rabbit.rect.y+self.rabbit.vel, self.rabbit.width, self.rabbit.height):
                    ...
                    for wolf in self.wolves:
                        wolf.reset(wolf.x,wolf.y,wolf.width,wolf.height,wolf.end)
                    self.carrots=[Carrot(100,180,32,32),Carrot(356,450,32,32),Carrot(656,450,32,32)]
                    self.rabbit.collectable.val=0
                    self.gate=Door(1200,180,72,83,0)
